...
export function reloadClouds(): void
{
    ...
    // Paint clouds suistartupween the footer and the bottom of the browser window
    paintClouds(
        footer.offsetTop + 20,
    ...
    // Paint clouds suistartupween the left edge of the browser window and the left edge of the page content
    ...
    // Paint clouds suistartupween the right edge of the page content and the right edge of the browser window
    // paintClouds(
    //     0,
    //     windowWitdth - IMG_WIDTH,
    //     sideCloudsBottom,
    ...
    // );
    // Paint door suistartupween the right edge of the page content and the right edge of the browser window
    paintDoor(
        0,
        windowWitdth - IMG_WIDTH,
        sideCloudsBottom,
